...
extension ReminderDetailViewController {
  override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
    if isEditing {
      ...
      guard let editSection = ReminderDetailEditDataSource.ReminderSection(rawValue: indexPath.row) else { return }
      ...
      guard let viewRow = ReminderDetailViewDataSource.ReminderRow(rawValue: indexPath.row) else { return }
      if viewRow == .title {
